	...
	$(".exitway").on("click", function(){
		...
		event_names[0] = ["Fashion Show"];
		
	/**For Tech "combine them"**/

		event_names[1] = ["Solo Singing"];
		event_names[2] = ["Battle of Bands"];
		event_names[3] = ["Solo & Group Dance"];
		event_names[4] = ["Nukkad Natak"];
		//event_names[5] = ["Clash of DJs"];
		...
		event_details[0][0] = [["Introduction",'<p> Many designers of Apeejay Stya University and students from outside and other colleges showcase their beautiful dresses in this event. Students participate to show their talent of designing dresses and showing their catwalk on ramp.</p>'],["Rules",'<p> <ul><li>All participants must bring their ID cards.</li><li> No. of models per team 8 to 10. </li><li> Accompanist per team-maximum 5 (including of designers, makeup artist and back stage help)</li><li> Time -15 minutes including 4 minutes for setup.</li><li> Participants should bring their own song if they have any specification theme else default song will be played.</li></ul></p>'],["Student Coordinator",'<p><li>Neeraj Sinha</li><li>Kratika Mehrotra</li></p>'],["Faculty Coordinator",'<p> <ul><li>Mrs. Chetna Patiyal</li><li>Ms Ashima Arora</li></p>'],["Contact Details",'<p></p><p><li>Kratika Mehrotra- 7027806706</li></p><p>kratika.mehrotra@asu.apeejay.edu</p><p><li>Neeraj Sinha - 8006667678</li></p><p>neeraj.Sinha@asu.apeejay.edu</p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/fashion.jpg">poster</a>']];

		event_details[1][0] = [["Introduction",'<p> It is said that “Singing is the best feeling in the world”. Students from Apeejay Stya University and from other colleges express their feelings through their melodious voice.</p>'],["Rules",'<p> <ul><li> Time limit for singing is minimum 3 minutes and maximum 4 minutes. After 4 minutes the participants will have negative markings.</li><li> Participants must bring their own instrument or instrumental (karaoke) music to perform.</li></ul></p>'],["Student Coordinator",'<p><li>Justina</li></p>'],["Faculty Coordinator",'<ul><p><li> Mrs.Ekta Bhayana</li><li> Mrs.Manju Aggarwal </li></p>'],["Contact Details",'<p></p><p><li>Justina - 9408530694</li></p></p><p></p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/solo.jpg">poster</a>']];

		event_details[2][0] = [["Introduction",'<p> In this event more than two bands compete each other in order to get the title of best band. Bands from different colleges and from Apeejay Stya University compete.</p>'],["Rules",'<p> <ul><li> Every band must play 2 songs, out of which one must be their original work.</li><li> Each band will be allotted 15 minutes for their both performance.</li><li> Each band should bring their own musical cords, aux wires in case of emergency.</li><li>Apeejay Stya University will not be responsible for any broken equipment. Injuries or any other negative occurrences.</li><li> The winner of battel of bands may be asked to play a song of their own collection for 10-15 minutes (which must be different from the previous one.)</li></ul></p>'],["Student Coordinator",'<p> <li>Ravi Kumar</li></p><p><li>Vaibhav Kapoor</li></p>'],["Faculty Coordinator",'<p> <ul><li> - </li><li> - </li></p>'],["Contact Details",'<p></p><p><li>Ravi Kumar - 9729033630</li>ravi.kumar@asu.apeejay.edu</p><p><li>Vaibahv Kapoor - 9953218406</li>vaibhav.kapoor@asu.apeejay.edu</p>'],["Registration & Poster", '<a href=" - ">to be updated.</a><br><br><a href="resources/bob.jpg">poster</a>']];

		event_details[3][0] = [["Introduction",'<p> Dance is the hidden language of the Soul. Apeejay Stya university providing platform for the students of Apeejay and from outside to perform their talent on the stage.”</p>'],["Rules",'<p> <ul><li> Participant can participate in all the categories.</li><li> Time limit is minimum 3 minutes for solo, 3 minutes for duet and maximum 4 minutes for the same. And for the group dance 6-7 minutes will be provided. </li><li> Participants are required to bring their own music CDs (in .dat/.wma/.mp3)and props.</li><li> The minimum number of participants in group dancing will be 6 and maximum can be 8.</li></ul></p>'],["Student coordinator",'<p><li> Ankita Singh</li></p> </p><p><li> Vansh Chadda</li></p>'],["Faculty coordinator",'<p></p><p><li>Mrs. Deepti Juneja</li></p><li>Mrs.shobhna</li></p><p><li>Mrs.Ashu</li></p>'],["Contact Details",'<p><li>Ankita Singh-9905905267</li> ankita.kumar@asu.apeejay.edu</p><p><li>Vansh Chadda-9540401869</li>vansh.chadda@asu.apeejay.edu</p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/dance.jpg">poster</a>']];

		event_details[4][0] = [["Introduction",'<p> Nukkad Natak is the combination of spirit-plot-audience-drama-themes-crowd-cause</p>'],["Rules",'<p> <ul><li> This is an individual on the spot competition. There is no limit of entries from a college.</li><li> Time limit is 45 minutes.</li><li> The participants shall bring their own material.</li><li> Primary printed area should be there. However neck, chest, shoulders may also be painted.</li><li> Profane or offensive painting will be disqualified.</li><li> Sponges, brushes or air brush techniques maybe used.</li></ul></p>'],["Student Coordinator",'<p> <li> Akshay Anthony</li></p>'],["Faculty Coordinator",'<p> <ul><li>Dr.Vineet Sharma</li></p><p> <ul><li>Mrs.shobhna</li></p><p> <ul><li>Mr.Anuranjan Sharma</li></p>'],["Contact Details",'<p></p><p><li>Akshay Anthony - 9911665430</li>akshay.anthony@asu.apeejay.edu</p>'],["Registration & poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/nukkad.jpg">poster</a>']];

/*		﻿﻿event_details[0][5] = [["Introduction",'<p> “Art is not what you see but what you make others”. So Apeejay Stya University heartly welcomes all the artists to express their talent.</p>'],["Rules",'<p> <ul><li> This is an individual on the spot competition. There is no limit of entries from a college. </li><li> Time limit is 45 minutes.</li><li> The participants shall bring their own material.</li><li> Primary printed area should be there. However neck, chest, shoulders may also be painted.</li><li> Profane or offensive painting will be disqualified.</li><li> Sponges, brushes or air brush techniques maybe used.</li></ul></p>'],["Student coordinator",'<p><li>Saksha Goel</li><li>Swati Singh</li></p>'],["Faculty coordinator",'<p><li> Amit Salathia</li></p>'],["Contact Details",'<p><li>Saksha Goyal - 7836850546</li><li>Swati Singh- 9992403328</li></p>'],["Registration & Poster",'<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/face.jpg">poster</a>']];

		﻿event_details[0][6] = [["Introduction",'<p> Poetry recitation with a little twist. Test your aptitude for recitation against others and show your love for poetry in this stirring competition of poetry!<br><br>Registration – Pre-registrations only. Individual participation.</p>'],["Rules",'<p> <ul><li> There would be two rounds–</li><li>Recite poetry of your choice.</li><li>Recite poetry of our choice.</li><li> There will be elimination in round 1. Only selected students will proceed to round 2.</li><li> 2-3 minutes would be given for recitation.</li><li> Poems must be recited from memory, use of sheets or phones will not be allowed.</li><li> Poems can be modern or classic – but should be from well-known poets.</li><li> Medium of poetry – Hindi or English.</li></ul></p>'],["Student coordinator",'<p><li>Vanshika Singh</li></p>'],["Faculty coordinator",'<p><li> Malvika Singh</li><li> A.D. Gurunathan</li></p>'],["Contact Details",'<p><li>Vanshika Singh - 9971427055</li></p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/pol.jpg">poster</a>']];
	
		event_details[0][7] = [["Introduction",'<p> Quizzes have never been more exciting! Match your wits against others in this crazy maze of letters, words, phrases and puzzles! A fun event comprising of questions from a multitude of word games such as spell bee, hangman, scrabble and baffling riddles!<br><br>Registration – On the spot registrations allowed. Individual participation.</p>'],["Rules",'<p> <ul><li> Total 30 questions. Three rounds. 10 questions per round.</li><li> 1 min per question.</li><li> Each round will have elimination. Top 10 scorers will proceed to round 2. Top 5 to round 3.</li></ul></p>'],["Student Coordinator",'<p><li> Poojita Suri</li></p>'],["Faculty Coordinator",'<p> <ul><li>Malvika Kaul</li><li> AD Gurunathan</li></p>'],["Contact Details",'<p></p><p><li>Poojita Suri - 9930710795</li>poojita.suri@asu.apeejay.edu</p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/mishmash.jpg">poster</a>']];

		event_details[0][8] = [["Introduction",'<p>School of design and visual art in collaboration with other streams of Apeejay Stya University will exhibit models, 2d posters, and movie and prototype products to answer our problems. These problems are based in two broad categories of INTERIOR & GRAPHICS. And this will be named as design n solution exhibition.</p>'],["Rules",'<p><li> - </li>'],["Student Coordinator",'<p><li>Lipika Agarwal</li><li>Milind</li></p>'],["Faculty Coordinator",'<p> <ul><li> Ms.Nupur Jha </li><li>Ms.Ashima Arora</li></p>'],["Contact Details",'<p><li>Lipika Agarwal - 9818880725</li><li>Milind - 9992882301</li></p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/design.jpg">poster</a>']];
*/
		//event_details[5][0] = [["Introduction",'<p> Its DJ mixing competition in which you have the freedom to entertain the crowd for 30 mins with your own innovative beats and music.</p>'],["Rules",'<p> <ul><li>Teams of maximum 2 are allowed. </li><li>One pioneer mixer will be provided.</li><li> Teams can bring their own mixers.</li><li>Normal mashup of songs are not allowed.</li><li>Judging will be based on innovative music, beats throughout the music performance.</li>'],["Student Coordinator",'<p><li> Rishabh Kapoor </li></p>'],["Faculty Coordinator",'<p> <ul><li>Dr.Sonam Raheja </li></p>'],["Contact Details",'<p><li>Rishabh Kapoor - 7838086030</li></p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/cod.jpg">poster</a>']];

//		event_details[0][10] = [["Introduction",'<p> “The Ad Mad Show where creativity meets. Show your skills to sell given products.”</p>'],["Rules",'<p><li>Number of participants per team – 4.</li><li>Topic will be provided on the spot.</li><li>30 minutes for preparation will be provided and stationary shall also be provided to the teams.</li><li>Every ad should not be for more than 2 minutes beyond that negative marking shall be observed.</li><li>Any team indulging in defamation, violence, Obscenity and prejudice shall be immediately disqualified.</li><li>Use of pre-existing brands is prohibited.</li></p>'],["students Coordinator",'<p><li>Lokesh Singh</li><li>Ankit Singh</li></p>'],["Faculty Coordinator",'<p><li>Prof. Deepak Halan</li></p>'],["Contact Details",'<p><li>Lokesh Singh - 9996635265</li></p>'],["Registration & Poster", '<a href="https://goo.gl/forms/A01ldOQcwzpQxG4w1">Register</a><br><br><a href="resources/mad.jpg">poster</a>']];
