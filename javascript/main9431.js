	...
	/**For Tech "combine them"**/
		...
		event_names[3] = ["Group Dance"];
		event_names[4] = ["Nukkad Natak"];
		event_names[5] = ["IPL Auction"];
		event_names[6] = ["Model United Nations"];		
